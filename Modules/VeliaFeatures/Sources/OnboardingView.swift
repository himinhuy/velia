...
struct OnboardingView: View {
    ...
    private var asksCycle: Bool {
        mode?.predictsCycle ?? true
    }
            ...
            Form {
                Section {
                    Text(L2("Chào mừng đến với Velia", "Welcome to Velia"))
                        .font(.title2.bold())
                    Text(L2(
                        "Vài câu hỏi nhanh để Velia hữu ích ngay từ hôm nay. Bạn luôn có thể chỉnh lại sau.",
                ...
                if asksCycle {
                    Section(L2("Kỳ kinh gần nhất", "Last period")) {
                        ...
                        if knowsLastPeriod {
                            DatePicker(
                                L2("Ngày bắt đầu", "Start date"),
                                selection: $lastPeriod,
                                in: ...Date(),
                    ...
                    Section(L2("Độ dài chu kỳ thường gặp", "Typical cycle length")) {
                        ...
                        Text(L2(
                            "Khoảng cách giữa hai lần bắt đầu kỳ kinh. Mặc định 28 ngày.",
                    ...
                    Section(L2("Số ngày hành kinh", "Period length")) {
                        ...
                        Text(L2(
                            "Kỳ kinh của bạn thường kéo dài bao nhiêu ngày (thường 2–6 ngày).",
                ...
                Section {
                    ...
                    Text(L2(
                        "Tuổi giúp tinh chỉnh dự đoán. Dữ liệu chỉ ở trên máy của bạn.",
