...
struct TrackItem: Identifiable, Hashable {
    ...
    var label: String { L2(labelVI, labelEN) }
}
...
enum TrackCatalog {
    ...
    static let pains: [TrackItem] = [
        ...
        TrackItem(id: "tender_breasts", labelVI: "Căng tức ngực", labelEN: "Tender breasts", symbol: "heart.fill", color: .blue),
    ...
    static let sex: [TrackItem] = [
        ...
        TrackItem(id: "unprotected", labelVI: "Không bảo vệ", labelEN: "Unprotected", symbol: "heart.fill", color: .rose),
    ]
    ...
    static let discharge: [TrackItem] = [
        ...
        TrackItem(id: "unusual", labelVI: "Bất thường", labelEN: "Unusual", symbol: "exclamationmark.circle", color: .teal),
    ]
}
